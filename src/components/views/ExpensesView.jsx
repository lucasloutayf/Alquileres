    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-8 flex items-center gap-4 border border-gray-200 dark:border-gray-700">
          ...
          <div>
            <div className="text-sm text-gray-500 dark:text-gray-400 mb-1 font-medium">{t('expenses.total')}</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700 min-h-[220px]">
          <h2 className="text-lg font-bold mb-4 text-gray-900 dark:text-gray-100">{t('expenses.byCategory')}</h2>
          <BarChart data={byCategory} title="" barColor="emerald" theme={theme} />
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700 min-h-[220px]">
          <h2 className="text-lg font-bold mb-4 text-gray-900 dark:text-gray-100">{t('expenses.byProperty')}</h2>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow px-8 py-6 border border-gray-200 dark:border-gray-700">
        <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('expenses.detail')}</h2>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
              <tr>
                <th className="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">{t('expenses.table.description')}</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">{t('expenses.table.property')}</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">{t('expenses.table.category')}</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">{t('expenses.table.amount')}</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">{t('expenses.table.date')}</th>
                <th className="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">{t('expenses.table.actions')}</th>
              </tr>
            </thead>
      ...
      <ConfirmModal
        ...
        title={t('expenses.deleteConfirm.title')}
        message={t('expenses.deleteConfirm.message')}
